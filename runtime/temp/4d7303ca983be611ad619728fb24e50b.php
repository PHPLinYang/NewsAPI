<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\xampp\htdocs\news\public/../application/admin\view\article\add.html";i:1556601296;s:61:"D:\xampp\htdocs\news\application\admin\view\public\_meta.html";i:1555833688;s:63:"D:\xampp\htdocs\news\application\admin\view\public\_footer.html";i:1555833633;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<body>
<article class="cl pd-20" style="margin: 0 35px 0 -100px;">
	<form action="save" method="post" class="form form-horizontal">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>分类：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<select name="cate_id" class="input-text" style="width: 120px;">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" autocomplete="off" value="" placeholder="" name="author">
			</div>
		</div>
		<div class="row cl">
